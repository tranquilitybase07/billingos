...
function fillGaps(data: { date: string; value: number }[] | undefined, defaultValue = 0) {
    if (!data) return []
...
export function DashboardCharts() {
    ...
    const activeSubData = growthData
    ...
    const charts = [
        {
            title: 'Total Revenue',
            value: isLoading ? 'Loading...' : formatCurrency(revenueTrend?.total_revenue || 0),
        ...
        {
            title: 'MRR',
            value: isLoading ? 'Loading...' : formatCurrency(mrrData?.mrr || 0),
        ...
        {
            title: 'ARR',
            value: isLoading ? 'Loading...' : formatCurrency((mrrData?.mrr || 0) * 12),
        ...
        {
            title: 'New Customers',
            value: isLoading ? '...' : `+${growthTrend?.summary.total_new || 0}`,
        ...
        },
        {
            ...
            value: isLoading ? '...' : (mrrData?.active_subscriptions || 0).toString(),
        ...
        {
            title: 'Churn Rate',
            value: isLoading ? '...' : formatPercent(churnTrend?.summary.avg_churn_rate || 0),
