...
const Sidebar = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'fixed top-(--banner-height,0px) bottom-0 z-10 hidden w-(--sidebar-width) transition-[left,right,top,width] duration-200 ease-linear md:flex',
          side === 'left'
...
const SidebarMenuSkeleton = ({
  ...
  /* eslint-disable react-hooks/purity -- intentional: random width for skeleton loading placeholder */
