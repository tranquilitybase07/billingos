...
import { UsageService } from '../billing/entitlements/usage.service';
...
export class FeaturesService {
  ...
  /**
   * Track usage for a feature — delegates to UsageService
   */
  async trackUsage(trackDto: TrackUsageDto) {
    return this.usageService.trackUsage(trackDto);
  }
  ...
  /**
   * Get usage metrics for a customer's features — delegates to UsageService
   */
  async getUsageMetrics(customerId: string, featureName?: string) {
    return this.usageService.getUsageMetrics(customerId, featureName);
  }
  ...
  // cleanupExpiredIdempotencyKeys cron moved to UsageService
}
