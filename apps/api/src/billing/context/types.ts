...
export interface BillingContext {
  ...
  /** True when a trialing sub downgrades in-place to any paid plan (lower amount,
   *  with or without its own trial config). The original trial_end is preserved
   *  through the swap. */
  isTrialingDowngrade: boolean;
